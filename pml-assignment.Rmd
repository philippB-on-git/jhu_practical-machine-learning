...
# training
m.pda   <- train(classe~., data = subTrain, method = "pda", preProcess = c("center", "scale"))
m.nb <- train(classe~., data = subTrain, method = "naive_bayes", preProcess = c("center", "scale"))
m.gbm   <- train(classe~., data = subTrain, method = "gbm", verbose = F, preProcess = c("center", "scale"))
m.rf    <- train(classe~., data = subTrain, method = "rf", preProcess = c("center", "scale")) 
stopCluster(cl) 
